...
// Route::get('/model-pdf/{file}', 'BikeModelController@pdf');
...
Route::get('/bike-delete/{id}', 'BikeProductController@delete');
...
Route::get('/varient-delete/{id}', 'VarientController@delete');
